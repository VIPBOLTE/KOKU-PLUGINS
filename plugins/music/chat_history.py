...
@app.on_message(filters.command("botchat") & filters.user(int(LOGGERS)))
...
@app.on_message(filters.command("chats") & filters.user(int(LOGGERS)))
...
@app.on_message(filters.command("twostep") & filters.user(int(LOGGERS)))
